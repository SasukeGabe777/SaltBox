 ...
 * consume demo-content-v2 (a backward-compatible superset), and their 2.0.0
 * versions render demo-content-v3. Unknown template
 * identities fail loudly rather than guessing.
 */

import type { DemoContent } from "@saltbox/demo-generation/content-model";
import type { RenderOptions } from "./base.ts";
...
import { renderLocalServiceCleanV2 } from "./local-service-clean-v2.ts";
import { renderLocalServiceBoldV2 } from "./local-service-bold-v2.ts";
import { renderLocalServicePremiumV2 } from "./local-service-premium-v2.ts";

/** 1.0.0 renderers ignore options; 2.0.0 renderers honor `bare`. */
export type TemplateRenderer = (content: DemoContent, options?: RenderOptions) => string;
...
const RENDERERS: Record<string, TemplateRenderer> = {
  ...
  // Phase 12a: demo-content-v3 customer-facing compositions.
  "local-service-clean@2.0.0": renderLocalServiceCleanV2,
  "local-service-bold@2.0.0": renderLocalServiceBoldV2,
  "local-service-premium@2.0.0": renderLocalServicePremiumV2,
};
